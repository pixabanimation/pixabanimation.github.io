      ...
      container.innerHTML = `
        <div class="admin-toolbar" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:20px">
          <div>
            ...
            <p style="font-size:0.8rem;color:var(--text-muted);margin:4px 0 0">Manage popup ads shown site-wide. Visitors see 2 popups per visit, alternating between 2 groups of ads.</p>
          </div>
        ...
        <div style="text-align:center;padding:60px;border:2px dashed var(--border-light);border-radius:var(--radius-lg)">
          <i class="fas fa-window-restore" style="font-size:3rem;color:var(--text-muted);margin-bottom:16px;display:block"></i>
          <h3 style="margin-bottom:8px">No popup ads yet</h3>
          <p style="color:var(--text-muted);margin-bottom:20px">Create popup ads that appear to visitors with alternating groups.</p>
            ...
            <div class="glass" style="padding:20px;border-radius:var(--radius-md);display:grid;grid-template-columns:1fr auto;gap:16px;align-items:start;opacity:${ad.is_active ? '1' : '0.5'}">
              <div>
                <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
                  <span style="font-size:1.2rem;color:var(--accent-1);width:28px;text-align:center"><i class="fas ${ad.icon || 'fa-bullhorn'}"></i></span>
                  <div>
